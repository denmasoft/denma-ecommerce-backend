...
class OrdersDashboardApplication(DashboardApplication):
    ...
    permissions_map = {
        'reset-orders': (['is_staff'], ['partner.dashboard_access']),
    ...
    reset_orders = get_class('dashboard.orders.views', 'ResetOrdersView')
    ...
    def get_urls(self):
        urls = [
            ...
            url(r'^reset-orders/$', self.reset_orders.as_view(), name='reset-orders'),
